...
- [ ] **Dev 1**: React + MapLibre UI scaffold; conversation layout, recommendation banner stub.
...
- [ ] **Dev 1**: Render GeoJSON on MapLibre (PFZ lines, warning polygons, route lines, harbor pins).
...
- [ ] **Dev 1**: Evidence drawer and high-level Agent Trace timeline components.
