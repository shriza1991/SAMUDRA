...
| **M4** | Marine, Geo, Risk & Route Domain | OFFLINE_VERIFIED | Deterministic risk engine, Shapely geofence evaluation, PFZ Haversine ranking engine, Synthetic demo dataset generator with 5 sectors and 240 canonical replay positions across 8 vessels | pytest domain & synthetic (25 passed) |
